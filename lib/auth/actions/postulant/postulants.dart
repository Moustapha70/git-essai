...
class Postulants extends StatefulWidget {
  const Postulants({Key key}) : super(key: key);

  @override
  _PostulantsState createState() => _PostulantsState();
}

class _PostulantsState extends State<Postulants> {
  @override
                    ...
                    SizedBox(
                      child: Expanded(
                        ...
                        child: Container(
                          ...
                          color: Colors.white,
                          child: Center(
                            child: Text("postulant".toUpperCase()),
                          ),
                        ),
                      ),
                    ),
